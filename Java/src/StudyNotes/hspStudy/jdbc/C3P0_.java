...
public class C3P0_ {
    ...
    public void testC3P0_02() throws SQLException {
        ComboPooledDataSource comboPooledDataSource = new ComboPooledDataSource("hspedu_01");
        //测试 5000 次连接 mysql
        long start = System.currentTimeMillis();
        ...
        long end = System.currentTimeMillis();
        //c3p0 的第二种方式(500000) 耗时=1518
        System.out.println("c3p0 的第二种方式(500000) 耗时=" + (end - start));//1518
    }
}