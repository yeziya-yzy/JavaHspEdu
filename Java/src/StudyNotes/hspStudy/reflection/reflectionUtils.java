...
public class reflectionUtils {
    ...
    public void api_02() throws ClassNotFoundException {
        //得到 Class 对象
        Class<?> personCls = Class.forName("StudyNotes.hspStudy.reflection.Person");
    ...
    public void api_01() throws ClassNotFoundException, NoSuchMethodException {
        ...
        Class<?> personCls = Class.forName("StudyNotes.hspStudy.reflection.Person");
        //getName:获取全类名
        System.out.println(personCls.getName());//StudyNotes.hspStudy.reflection.Person
        ...
        System.out.println(personCls.getPackage());//StudyNotes.hspStudy.reflection
